...
# Load the TSV file
file_path = '/Users/boshra/Desktop/CEAMS internship/data/figures_PSA/SIGMA power_1sec_Transposed_transposed.tsv'
data = pd.read_csv(file_path, sep='\t')

# Specify the directory where you want to save the figures
specific_figure_path = '/Users/boshra/Desktop/CEAMS internship/data/figures_PSA/1sec_fft/'
...
def plot_and_save_power_spectral_curves(absolute_data, relative_data, stage, specific_figure_path, log_scale=False):
    ...
    plt.savefig(f"{specific_figure_path}{filename_fig}_1sec.pdf")
    plt.close()
